...
//        System.out.println(Lekcja.Size.SMALL.getDescription() + " " + Lekcja.Size.SMALL.name() + " " + Lekcja.Size.SMALL.ordinal());
//        System.out.println(Lekcja.Size.MEDIUM.getDescription() + " " + Lekcja.Size.MEDIUM.name() + " " + Lekcja.Size.MEDIUM.ordinal());
//        System.out.println(Lekcja.Size.LARGE.getDescription() + " " + Lekcja.Size.LARGE.name() + " " + Lekcja.Size.LARGE.ordinal());
